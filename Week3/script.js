...
// Order of the arguments needs to be considered when passing the value
greetCustomer("Nana", "London");
// Calling function with 1 arguments
...
// Function for all 4 Arithmetics Operation it will be +,-,*,/
/*
...
console.log(div(5, 45));
*/

//  ------------ FUNCTION EXPRESSION  ------------
// A function to calculate the total price based on the quantity and price of a pizza
...
// Using ARROW FUNCTION, alterative of function expression
// No hoising,
...
// If there are no parameters then still you shoukd have empty ()
let calculateTotalPriceUsingArrow = (quantity, pricePerPizza) =>
  quantity * pricePerPizza;

// Calling the function
let totalArrow = calculateTotalPriceUsingArrow(3, 10);
console.log("Total price usign arrow function is: " + totalArrow);
...
// In arrow 
let displayMessageArrow = () =>
  alert("Attention I am a message in an arrow function");
...
// useed as callback or inline
let totalPriceAnonymous = (function (quantity, pricePerPizza) {
  return quantity * pricePerPizza;
})(3, 10); // Immediate passed arguments

let variableName = (function (param1, param2) {})(param1, param2);
